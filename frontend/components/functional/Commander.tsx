...
export function Commander({projects}: CommanderProps) {
  ...
  useEffect(() => {
    const down = (e: KeyboardEvent) => {
      ...
      if (e.key === "g" && (e.metaKey || e.altKey)) isGenerateImageDrawerOpen.value = true
      if (e.key === "s" && (e.metaKey || e.altKey)) isCreateStackDrawerOpen.value = true
      if (e.key === "p" && (e.metaKey || e.altKey)) isCreateProjectDrawerOpen.value = true
    }
